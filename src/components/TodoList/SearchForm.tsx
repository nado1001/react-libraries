...
import { searchTextFormState } from '../../states/atoms/SearchTextFormAtom';

export const SearchForm: React.VFC = () => {
  const searchTextFormValue: string = useRecoilValue(searchTextFormState);
  const setSearchTextFormValue: SetterOrUpdater<string> = useSetRecoilState(searchTextFormState);
